...
//types
#define TOML_TYPE						(0b1111000000000000)
#define TOML_VALUE						(0b0000111111111111)
#define TOML_ARRAY_TYPE					(0b1111100000000000)
#define TOML_ARRAY_VALUE				(0b0000011111111111)
