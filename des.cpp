...
unsigned long long _des::encrypt (unsigned long long in, unsigned long long key)
{
...
unsigned long long _des::decrypt (unsigned long long in, unsigned long long key)
{
	gen_key_array(key, keys);
	split(first_permutation(in), &left, &right);
	for (j = 0; j < 16; j++)
...
const short _des::first_permutation_table[64]=
{
...
const short _des::final_permutation_table[64]=
{
...
const short _des::expanding_permutation_table[48]=
{
...
const short _des::first_key_permutation_table[56]=
{
...
const short _des::second_key_permutation_table[48]=
{
	14, 17, 11, 24,  1,  5, 
	 3, 28, 15,  6, 21, 10, 
	23, 19, 12,  4, 26,  8, 
...
const short _des::p_permutation_table[32]=
{
